        ...
        $(xml).each(function(i,e0){
          ...
          $(e0.attributes).each(function(i,e1){
            ...
            if(iNode == "1"){
              ...
              attrInput += attrName + '<div class="input-field inline"><input  id="' + attrName + '" type="text" value="' + attrValue + '"></div></div></div>'
            }else{
          ...
          if($(xml).children().length == 0){
            if(iNode == "1"){
              attrInput = '<div  id="div'+ iNode + '" style="display:block"><div class="row"><div class="col s12">'
              attrInput += 'text<div class="input-field inline"><input  id="' + nodeName + '" type="text" value="' + nodeValue + '"></div></div></div>'
            }else{
              attrInput = '<div  id="div'+ iNode + '" style="display:none"><div class="row"><div class="col s12">'
              attrInput += 'text<div class="input-field inline"><input  id="' + nodeName + '" type="text" value="' + nodeValue + '"></div></div></div>'
            }
